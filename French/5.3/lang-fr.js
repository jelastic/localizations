...
//    LT_Environments_Confirm_RestartNode         : "Redémarrer%(sType)?",
    ...
    LT_Deploy_Column_Comment                    : "Commenter",
    ...
    LT_EnvironmentSettings_Label_Name           : "Nom de l'environnement",
    ...
    LT_Common_Text_Comment                      : "Commenter",
    ...
    LT_BugReport_Label_Comment                  : "Commenter",
...
//    LT_EnvWizard_W_MaxvInstances_TrialRegistered: "Votre compte limite le nombre d'instances de serveurs d'application à %(count) par environnement. Veuillez <a action='refill' target='_blank'>recharger</a> votre solde pour supprimer cette limitation.",
    ...
    LT_Import_SuccessDlg_Note                   : "<b>Remarque</b>: pour être en mesure de fonctionner, l'environnement importé peut nécessiter une nouvelle configuration adaptée aux paramètres du nouvel hébergeur (comme une IP publique). <br/><br/><div class=\"more-info\">Plus d'informations à [link]%(href)[/link]</div>",
    ...
    "LT_Region_DisplayName_vz7"     : "Docker Native (Bern)",
    ...
    LT_EnvWizard_Label_EnvName                  : "Nom de l'environnement",
    LT_Marketplace_Label_EnvName                : "Nom de l'environnement",
    ...
    LT_Docs_ZDTModule                           : "En savoir plus sur l'option de déploiement [link-docs] sans interruption de service [/ link-docs] .",
    ...
    LT_OptionsCost_Text_IPv6_Desc               : "C'est une adresse IPv6 externe directement accessible depuis l'extérieur du cluster. Les chargent sont prise toutes les heures.",
    ...
    LT_Common_Text_MaxExtIPPerEnv               : "La quantité maximale d'adresses publiques [FORMAT_IP_TYPE]%(type)[/FORMAT_IP_TYPE] par environnement est de <b>% (maxcount) </ b>. [TEXT_INCREASE_LIMITS/].",
    ...
    LT_Common_Text_MaxExtIPPerNode              : "Le nombre maximum d'adresses publiques [FORMAT_IP_TYPE]%(type)[/ FORMAT_IP_TYPE] par serveur est de <b>% (maxcount) </ b>. [TEXT_INCREASE_LIMITS/].",
    ...
    LT_EnvMigration_Error_Title                 : "Migration de l'environment %(envName)",
    ...
    LT_EnvProgress_Clone_Title_Failed			: "Le clonage de l'environment<b>%(name)</b> a echoué.",
    ...
    LT_ConfigManager_FileAlreadyExists          : "Le chemin <b>%(path)</b> existe déjà sur l'environment %(env).La structure du répertoire sera mise à jour.",
